  ...
  return (
    <div className=" py-4 px-4 justify-content-center slideee">
      ...
      >
        <SwiperSlide>
          <Link to="#">
            <img className="imgg" src="/amazon-image/box4_4.jpg" alt=''/>
          </Link>
        ...
        <SwiperSlide>
          <Link to="#">
            <img
              className="imgg"
              alt=''    src="/amazon-image/box4_4.jpg"
            />
          </Link>
          <Link className="price">
          <div  className="price1">
            <p>EGP 300 and under</p>
          </div>
          <div className="price2">
            <h5>White Friday Deal</h5>
          </div>
