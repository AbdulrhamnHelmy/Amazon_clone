        ...
        <Row>
          <Col lg={6} md={6} sm={12} className="left">
            ...
            <div>
              <h6>
                <span className="span">
                  Frequently Asked Questions about Amazon Egypt Head Office
                </span>{" "}
                :
                <br />
                <br />
                ...
                <br />
                A: Amazon Egypt Head Office is located at: HSBC Bank, Dar Al
                Salam, Giza Governorate, Egypt
                <br />
                <br />
                ...
                <br />
                A: Amazon Egypt Head Office has not rated yet on
                addressschool.com
                <br />
                <br />
          ...
          <Col lg={6} md={6} sm={12} className="form">
            <form className="form" ref={form} onSubmit={sendEmail}>
              ...
              <h5>
                By creating an accoun, you agree to Amazon's{" "}
                <Link to="/" className="link">
                  {" "}
                  Conditions of Use
                </Link>{" "}
            ...
            <div className="formFooter">
              <div>
                <Link to="/" className="formFooterLink">
                  Conditions of Use
                </Link>
                <Link to="/" className="formFooterLink">
                  Privacy Notice
